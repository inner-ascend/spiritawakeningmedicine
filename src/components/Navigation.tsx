          ...
          <div className="hidden lg:flex items-center gap-5">
            {isOnePager ? (
              ...
              <>
                ...
                <a
                  href="https://wa.me/33646396325?text=Hello%2C%20I%27m%20interested%20in%20learning%20more%20about%20your%20ceremonies."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-2 bg-[#25D366] text-white rounded-full font-semibold hover:bg-[#128C7E] transition-all text-sm"
                >
            ...
            {isOnePager ? (
              ...
              <>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 py-2 text-[#25D366] font-semibold"
                >
