...
const ResponsiveImage: React.FC<ResponsiveImageProps> = ({
  ...
  // e.g., "/images/portraits/nina-portrait.jpg" => "portraits-nina-portrait"
  const getOptimizedBaseName = (path: string) => {
    // Remove /images/ prefix and file extension
    const withoutPrefix = path.replace(/^\/images\//, '');
    const withoutExt = withoutPrefix.replace(/\.[^/.]+$/, '');

    // Replace slashes with dashes for flattened structure
