...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen">
      ...
      <div className="min-h-screen bg-sacred-white py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-6xl font-serif text-earth-800 mb-6 font-light">
                Privacy Policy
              </h1>
              ...
              <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm space-y-8">
                ...
                <section>
                  ...
                  <p className="text-earth-700 leading-relaxed">
                    At Spirit Awakening Medicine, we deeply respect your privacy and the sacred nature of the work we do together.
                    This policy outlines how we collect, use, and protect your personal information.
                  </p>
                </section>

                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Information We Collect</h2>
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">How We Use Your Information</h2>
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Confidentiality</h2>
                  <p className="text-earth-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Data Security</h2>
                  <p className="text-earth-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Cookies and Tracking</h2>
                  <p className="text-earth-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Your Rights</h2>
                  <div className="space-y-3 text-earth-700">
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Third-Party Services</h2>
                  <p className="text-earth-700 leading-relaxed">
                ...
                <section>
                  ...
                  <p className="text-earth-700 leading-relaxed">
                    The services offered by Spirit Awakening Medicine are complementary practices and are not a substitute
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Changes to This Policy</h2>
                  <p className="text-earth-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-serif text-earth-800 mb-4">Contact Us</h2>
                  <p className="text-earth-700 leading-relaxed mb-4">
                    If you have any questions about this privacy policy or how we handle your information,
                    please contact us:
                  </p>
                  <p className="text-earth-700">
                    Email: <a href="mailto:hello@spiritawakeningmedicine.com" className="text-sacred-gold hover:underline">hello@spiritawakeningmedicine.com</a>
                  </p>
                </section>

                <div className="pt-8 border-t border-earth-800/10 text-center">
                  <Link
                    to="/"
                    className="text-sacred-gold hover:text-earth-800 transition-colors"
                  >
                    ← Back to home
                  </Link>
                </div>
