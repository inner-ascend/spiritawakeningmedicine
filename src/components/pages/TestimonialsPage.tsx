  ...
  const testimonials = [
    {
      ...
      type: "Energy Healing & Integration",
      featured: true
    },
    {
      name: "Jon",
      ...
      type: "Bufo Ceremony & Integration",
      featured: true
    },
    {
      name: "Nina",
      ...
      <div className="min-h-screen relative flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl text-desert-sand/90 font-serif italic leading-relaxed max-w-3xl mx-auto">
            Real experiences from those who've walked this path
          </p>
        </div>
      ...
      <div className="h-[60vh] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-earth-900/40 via-transparent to-earth-900/40 flex items-center justify-center">
          <p className="text-3xl md:text-4xl font-serif text-sacred-white italic text-center px-4 max-w-4xl">
            "The medicine doesn't care if you believe in it.<br/>
            But your willingness to surrender—that's everything."
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-earth-700/80 leading-relaxed">
              If these stories resonate with you, if you feel the call,
              the application process is your next step.
            </p>
            ...
            <div className="space-y-4 pt-8">
              ...
              <p className="text-sm text-earth-700/60 italic">
                Private application · Mutual discernment · Medical screening required
              </p>
            </div>
